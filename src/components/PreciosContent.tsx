...
const comparisonRows: ComparisonRow[] = [
  ...
  {
    feature: "App nativa iOS & Android",
    starter: false,
    growth: true,
    scale: true,
    enterprise: true,
  ...
  {
    feature: "Sincronización Tiendanube",
    starter: true,
    growth: true,
    scale: true,
    enterprise: true,
  ...
  {
    feature: "Programa de fidelización",
    starter: false,
    growth: "Básico",
    scale: "Básico",
    enterprise: "Avanzado",
